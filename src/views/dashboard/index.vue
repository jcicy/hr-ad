      ...
      <div class="left">
        ...
        <div class="panel">
          ...
          <div class="chart-container">
            ...
            <div class="chart">
              <!-- 图表 -->
              <div ref="socialChart" style="width: 100%; height: 100%; " />
            </div>
          </div>
        </div>
        <!-- 图表数据 -->
        <div class="panel">
          ...
          <div class="chart-container">
            ...
            <div class="chart">
              <!-- 图表 -->
              <div ref="providentChart" style="width: 100%; height: 100%;" />
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    // 社保
    this.social = echarts.init(this.$refs.socialChart)
    // 公积金
    this.provident = echarts.init(this.$refs.providentChart)
  },
  methods: {
    async getHomeData() {
